...
SCNet requires COCO and [COCO-stuff](http://calvin.inf.ed.ac.uk/wp-content/uploads/data/cocostuffdataset/stuffthingmaps_trainval.zip) dataset for training. You need to download and extract it in the COCO dataset path.
