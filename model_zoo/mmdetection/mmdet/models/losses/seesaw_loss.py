...
class SeesawLoss(nn.Module):
    ...
    def __init__(self,
        ...
        # sam output channels of the classifier
        self.custom_cls_channels = True
        # sam activation of cls_score
        self.custom_activation = True
        # sam accuracy of the classsifier
    ...
    def get_cls_channels(self, num_classes: int) -> int:
        """Get sam classification channels.

        Args:
            num_classes (int): The number of classes.

        Returns:
            int: The sam classification channels.
        """
        assert num_classes == self.num_classes
        return num_classes + 2

    def get_activation(self, cls_score: Tensor) -> Tensor:
        """Get sam activation of cls_score.

        Args:
            cls_score (Tensor): The prediction with shape (N, C + 2).

        Returns:
            Tensor: The sam activation of cls_score with shape
                 (N, C + 1).
        """
    ...
    def get_accuracy(self, cls_score: Tensor,
        ...
        """Get sam accuracy w.r.t. cls_score and labels.
